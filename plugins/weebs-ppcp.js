...
let handler = async (m, { conn, usedPrefix, command }) => {
	try {
		...
		anu = anu.hasil
		await conn.sendMsg(m.chat, { image: { url: anu.cowok }, caption: `شارك الصورة مع حبيبتك\n\n *تابع صانع البوت فى إنستجرام ❤️* \n https://www.instagram.com/ovmar_1` }, { quoted: m })
		await conn.sendMsg(m.chat, { image: { url: anu.cewek }, caption: `شارك الصورو مع حبيبك \*تابع صانع البوت فى إنستجرام ❤️* \n https://www.instagram.com/ovmar_1` }, { quoted: m })
	} catch (e) {
		console.log(e)
		try {
