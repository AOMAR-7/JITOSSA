...
const handler = async (m, {
    ...
    const voiceMap = {
        en: "70ded880-ad19-4673-956c-20aeaa5d1695",
        fr: "b4962a67-ce24-4a3e-935b-e695b860d9cf",
        de: "58a9cbbd-ab42-4560-9c4f-e801a34e92a1",
        it: "b605a26e-14ab-46ff-b3ba-e440199f3cd4"
    };
    ...
    try {
        ...
        while (true) {
            ...
            if (videoResponse.status === 'complete') {
                await conn.sendFile(m.chat, videoResponse.download, '', 'Synthesia', m, false, {
                    mentions: [m.sender]
                });
                await conn.sendReact(m.chat, "✅", m.key)
