...
const handler = async (m, {conn, args, command, usedPrefix}) => {
  if (!args[0]) throw `*هاذا الأمر خاص بالتحميل من إنستجرام*\n\n*مثال:* _${usedPrefix + command} https://www.instagram.com/reel/Cc0NuYBg8CR/?utm_source=ig_web_copy_link_`;
  m.reply(global.wait);
  try {
      ...
      try {
        ...
        try {
          ...
          try {
            ...
            throw `*تابع صانع البوت فى إنستجرام ❤️* \n https://www.instagram.com/ovmar_1`;
          }
        }
      }
    }
